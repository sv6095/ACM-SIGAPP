...
const TeamSection = ({ title, members }) => {
  ...
  const gridCols = members.length === 1 ? "grid-cols-1" :
                   ...
                   members.length === 5 ? "grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5" :
...
const Team = () => {
  const clubInCharge = [
    { name: "Dr Vaishnavi Moorthy", role: "Faculty Sponsor", bio: "Providing guidance and support for the club's activities and projects.", image: "/images/vm.webp", social: {linkedin:"https://au.linkedin.com/in/vaishnavimoorthy",instagram:"https://www.instagram.com/srmacmsigapp?igsh=MTNmNzd2eTFycHBmNQ=="} },
    ...
    { name: "Yukta", role: "Treasurer", bio: "Managing resources and ensuring smooth operational functions.", image: "/images/Yukta.webp", social: {linkedin:"https://www.linkedin.com/in/yukta-bhardwaj-806467288", instagram:"https://www.instagram.com/yukta2106?igsh=YW9wcWd2bDRkemgx"} },
  ...
  const technicalTeam = {
    "Gen AI": [
      { name: "Kavinraj", role: "Head", bio: "Exploring generative AI and large language models.", image: "/images/Kavinraj.webp", social: {linkedin:"https://www.linkedin.com/in/kavinraj-mayilsamy", instagram:"https://www.instagram.com/srmacmsigapp?igsh=MTNmNzd2eTFycHBmNQ=="} },
    ...
    "Web/App Development": [
      ...
      { name: "Anushka Banerjee", role: "Lead", bio: "Leading the charge in smart on web/app development.", image: "/images/Anushka.webp", social: {linkedin: "https://www.linkedin.com/in/anu7hka/", instagram:"https://www.instagram.com/anusrkive?igsh=MWhlM25nMmZqY2Fjcw=="} }
    ],
    "Metaverse": [
      { name: "Ankit", role: "Head", bio: "Innovating immersive experiences and virtual worlds.", image: "/images/Ankit.webp", social: {linkedin:"https://www.linkedin.com/in/ankit-mandal-724890359", instagram:"https://www.instagram.com/srmacmsigapp?igsh=MTNmNzd2eTFycHBmNQ=="} },
      { name: "Rishav", role: "Lead", bio: "Designing interactive environments and game elements.", image: "/images/Rishav.webp", social: {linkedin:"https://www.linkedin.com/in/rishav-goswami-279789354", instagram:"https://www.instagram.com/srmacmsigapp?igsh=MTNmNzd2eTFycHBmNQ=="} }
    ]
  };
  ...
  const nonTechnicalTeam = {
     "Management": [
      ...
      { name: "Shedin", role: "Lead", bio: "Enhancing organizational efficiency and communication.", image: "/images/Shedin.webp", social: {linkedin:"https://www.linkedin.com/company/srm-acm-sigapp/", instagram:"https://www.instagram.com/shedin.ashraf?igsh=c2lsZ2VyNGxvbXdi"} }
    ],
    "Creatives": [
      { name: "Aqeel", role: "Head", bio: "Leading creative design and content initiatives.", image: "/images/Aqeel.webp", social: {linkedin:"https://www.linkedin.com/in/aqeel-umar-287aa8245", instagram:"https://www.instagram.com/aqeel_3301?igsh=dTN6NWowdXBtdWNk"} },
      ...
      { name: "Praveen", role: "Lead", bio: "Enhancing visual communication and branding strategies.", image: "/images/Praveen.webp", social: {linkedin:"https://www.linkedin.com/in/praveen-saravanan", instagram:"https://www.instagram.com/thegraxwizard?igsh=MThrb3Ywc3duOXVmOQ=="} }
    ],
   
    "Corporate": [
      { name: "Alka Sunil", role: "Head", bio: "Managing organizational and strategic initiatives.", image: "/images/Alka.webp", social: {linkedin:"https://www.linkedin.com/in/alka-sunil-52326b278", instagram:"https://www.instagram.com/alkaftw?igsh=NzR6ajZ0cGQ3M3Rj"} },
